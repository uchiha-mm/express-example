		...
		if(value){
			...
			if(value == 0){
				...
				proxy.web(req, res, {target: 'http://127.0.0.1:3000'});
				  	...
				  	console.log("Server serving the feature ", req.url, " is : ", ip);	
			...
			client.rpop('hotqueue:servers', function(err,value){
				var ip = value.slice(2, 23)
			  	console.log("Server serving is : ", ip);
				proxy.web(req, res, {target: ip});
			  	client.lpush(['hotqueue:servers', value], function(err, reply){	
			  	//	console.log(reply);	
			  	})  
			 })
		}
